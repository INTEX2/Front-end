        ...
        <bs.Container>
            <bs.Row>
                ...
                <bs.Col md="12" className="px-3 py-4 border-right" style={{backgroundColor: "white"}}>
                        <Input title="Will you automatically post this to Facebook?:" name="facebook" type="checkbox" disabled={props.form.isSubmitting} />
                        ...
                        <Input title="Goal:" name="goal" type="number" disabled={props.form.isSubmitting}/>
                        ...
                        <div hidden={props.prediciton === 0}>Your Predicted Donators will be: {parseInt(props.prediciton)}</div>
                </bs.Col>
            <bs.Row>
                <bs.Col className="px-3 py-4" style={{color:"white",backgroundColor: "royalBlue"}}>
